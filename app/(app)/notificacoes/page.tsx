...
export default function NotificacoesPage() {
  ...
  const { estoque: falta, atrasadas: contasAtrasadas, proximas: contasProximas, todos } =
    getAlertas(ingredientes, contasPagar);
                ...
                >
                  ...
                  <span className="min-w-0 flex-1">
                    ...
                    <span className="block text-xs text-muted">
                      {i.quantidadeAtual} {i.unidade} disponível · mínimo {i.estoqueMinimo}{" "}
                      {i.unidade}
                    </span>
                  </span>
                ...
                >
                  ...
                  <span className="min-w-0 flex-1">
                    ...
                    <span className="block text-xs text-muted">
                      ...
                      {mzn(c.valor)} · venceu {dataCurta(c.vencimento)}
                    </span>
                  </span>
