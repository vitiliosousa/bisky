...
function GridMateriais({ items }: { items: Material[] }) {
  return (
          ...
          >
            <div className="flex items-center justify-between gap-2">
              ...
              >
                {baixo ? (
                  ...
                  <Box className="size-4 sm:size-5" strokeWidth={1.75} />
                )}
              </span>
            ...
            <div className="mt-auto flex items-end justify-between gap-1.5">
              <div className="min-w-0">
                ...
                >
                  {m.quantidade}{" "}
                  <span className="text-xs font-normal text-muted">{m.unidade}</span>
                </p>
...
function ListaMateriais({ items }: { items: Material[] }) {
  return (
              ...
              >
                ...
                <span className="min-w-0 flex-1">
                  ...
                  <span className="mt-0.5 block text-xs text-muted">
                    {m.categoria} · {mzn(m.precoUnitario)}/{m.unidade}
                  </span>
                </span>
    ...
    () =>
      materiais
        .filter((m) => {
          ...
          const matchFiltro =
            filtro === "todos" || m.quantidade < m.estoqueMinimo;
        ...
        <div className="card">
          <Empty
            ...
            hint={
              busca || filtro !== "todos"
                ? undefined
                : "Adicione o seu primeiro material."
            }
          />
        </div>
      ) : (
          ...
          {view === "grid" ? (
            ...
            <>
              ...
              <div className="hidden sm:block">
                <ListaMateriais items={pageItems} />
              </div>
            </>
          )}
          <Pagination
